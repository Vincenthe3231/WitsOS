...
// Project page on GitHub Pages: https://colbymchenry.github.io/witsos/
// `site` + `base` make every internal link resolve under the /witsos/ prefix.
			...
			social: [
				{
					icon: 'github',
					label: 'GitHub',
					href: 'https://github.com/colbymchenry/witsos',
				},
			],
			customCss: [
