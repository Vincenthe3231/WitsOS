...
-- =============================================================================
-- Document / Knowledge Indexing (Phase 2+)
-- =============================================================================

-- Chunks: prose sections for full-text search over documents (txt/md/csv/pdf/…).
-- Bodies are stored here (not in nodes) so the nodes table stays code-symbol-shaped.
...
-- Full-text search over chunk prose bodies
