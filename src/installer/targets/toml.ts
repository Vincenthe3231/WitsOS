 ...
 * single dotted-key table block (`[mcp_servers.WitsOS]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.WitsOS]`
 ...
 *     the full dotted key `[mcp_servers.WitsOS]`).
