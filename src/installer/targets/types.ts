 ...
 */
export type TargetId = 'claude' | 'desktop' | 'cursor' | 'codex' | 'opencode' | 'hermes' | 'gemini' | 'antigravity' | 'kiro';
 ...
 *
 * `alreadyConfigured` reports whether WitsOS has already been
...
export interface InstallOptions {
   ...
   * WitsOS_explore context for structural prompts. `true` installs it,
...
export interface AgentTarget {
   ...
   * target. Used by `WitsOS install --print-config <id>` and by
