 ...
 */
const RELAUNCH_GUARD_ENV = 'WitsOS_WASM_RELAUNCHED';
 ...
 */
export const HOST_PPID_ENV = 'WitsOS_HOST_PPID';
 ...
 * disabled via WitsOS_NO_RELAUNCH.
 *
...
export function relaunchWithWasmRuntimeFlagsIfNeeded(scriptPath: string): void {
  ...
  if (process.env.WitsOS_NO_RELAUNCH) return;
