...
const explore = subCounts['mcp__witsos__WitsOS_explore'] || mainCounts['mcp__witsos__WitsOS_explore'] || 0;
...
console.log(`\nVERDICT: WitsOS_explore used ${explore}x | Read ${reads} | Grep/Bash ${greps}`);
